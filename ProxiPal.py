...
def sns_linearity_plot(df, gradient_column: str = 'SLR; log10(x); exc_std0; ct; grad', 
    ...
    in the same experiment (red); and a ideal model fit region for a PCR-efficiency of 0.95 - 1.05 across the same 
    ...
    # m1_model = -3.3208 #100% efficiency
    m1_model = -3.207 #105% efficiency
    m2_model = -3.448 #95% efficiency
